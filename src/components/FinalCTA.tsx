...
import { BOT_LINK, TELEGRAM_COMMUNITY } from "../lib/links";
  ...
  return (
    <section className="section-padding relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-4xl mx-auto relative text-center text-white">
        ...
        >
          {t.finalCta.title}{" "}
          <span className="text-accent">{t.finalCta.titleHighlight}</span>
        </motion.h2>
        ...
        >
          <motion.a
            ...
            className="group relative px-8 py-4 bg-accent text-primary-dark font-semibold rounded-full overflow-hidden"
...
{TELEGRAM_COMMUNITY[locale] && (
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 border-2 border-white/30 text-white font-semibold rounded-full hover:bg-white/10 transition-colors flex items-center gap-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
            >
